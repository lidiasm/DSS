...
public class CatalogoUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	public CatalogoUserServlet() {
		super();
	}
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        URL url = new URL("http://localhost:8080/catalogoJuguetes/rest/juguetes/usuario");  
