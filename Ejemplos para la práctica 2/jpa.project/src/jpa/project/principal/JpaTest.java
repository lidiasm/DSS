...
import jpa.project.modelo.Familia;
import jpa.project.modelo.Persona;
...
public class JpaTest {
  ...
  public void comprobarFamilias() {
    ...
    System.out.println("Miembros: " +((Familia) q.getSingleResult()).getMiembros().size());
